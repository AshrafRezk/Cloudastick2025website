...
const translations = {
  en: {
    ...
    'power.platform.challenges.personalized': 'Key Challenges We Solve for {company} in {industry}:',
  ...
  ar: {
    ...
    'power.platform.challenges.personalized': 'التحديات الرئيسية التي نحلها لـ {company} في {industry}:',
