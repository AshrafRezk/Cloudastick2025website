...
const TarwtlLeadCapture: React.FC = () => {
  ...
  const teamMembers = [
    { name: 'Bara Hamed', role: 'Sales Representative', userId: '005NM000001gxpVYAQ', image: '/Assets/team-members/Bara Hamed - 005NM000001gxpVYAQ.png' },
    { name: 'Habiba Walid', role: 'Sales Representative', userId: 'DEFAULT_USER', image: '/Assets/team-members/Habiba walid.png' },
    { name: 'Iyad Ahmad', role: 'Sales Representative', userId: '0053z00000D66YmAAJ', image: '/Assets/team-members/Iyad Ahmad - 0053z00000D66YmAAJ.png' },
    { name: 'Michel Khoury', role: 'Sales Representative', userId: 'DEFAULT_USER', image: '/Assets/team-members/Michel khoury.png' },
    { name: 'Moutasem Al-Huneidi', role: 'Sales Representative', userId: '005NM000001M0LlYAK', image: '/Assets/team-members/Moutasem Al-Huneidi - 005NM000001M0LlYAK.png' },
    { name: 'Nicolas Boulos', role: 'Sales Representative', userId: '005NM000001iFdtYAE', image: '/Assets/team-members/Nicolas Boulos - 005NM000001iFdtYAE.png' },
    { name: 'Nour El Hassan', role: 'Sales Representative', userId: '0053z00000C11ySAAR', image: '/Assets/team-members/Nour el hassan - 0053z00000C11ySAAR.png' },
    { name: 'Talal El Chammah', role: 'Sales Representative', userId: '005NM0000010MxhYAE', image: '/Assets/team-members/Talal El Chammah - 005NM0000010MxhYAE.png' },
    { name: 'Zaid Radaideh', role: 'Sales Representative', userId: '005NM000001w3OLYAY', image: '/Assets/team-members/Zaid radaideh - _005NM000001w3OLYAY.png' },
  ];
